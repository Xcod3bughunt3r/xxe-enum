...
Options
        ...
        --body <xml>\t\tThe normal POST request body, e.g. --body "<subscribe><email>admin@prisma.id</email><name>admin</name></subscribe>", default: <login><username>admin</username><password>admin1234</password></login>
        `
    );
    return;
}
...
var normal_xml = argv.body == undefined ? "<login><username>admin</username><password>admin1234</password></login>" : argv.body;
